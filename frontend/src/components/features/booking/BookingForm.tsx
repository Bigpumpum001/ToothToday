  ...
  return (
    <>
      <form onSubmit={Submit} className="flex flex-col items-center">
        ...
        <div className="grid items-center space-y-4 rounded-lg border border-gray-300 bg-white p-6 shadow xl:w-3/4 xl:grid-cols-2 xl:gap-5">
          <div className="xl:w-full">
            <label>เลือกบริการ</label>
            <select
              className="mt-1 w-full rounded-2xl border border-gray-300 p-2 focus:ring-2 focus:ring-blue-300 focus:outline-none"
            ...
            {!selectedService ? (
              <h3 className="mt-3 text-center text-lg font-normal">
                {" "}
          ...
          <div
            ...
            className="flex flex-col space-y-4 xl:w-full xl:p-5"
          >
            <div className="">
              <label className="">เลือกเวลา</label>
              <select
                className="mt-1 w-full rounded-2xl border border-gray-300 p-2 focus:ring-2 focus:ring-blue-300"
            ...
            <div className="">
              ...
              <input
                type="file"
                className="bmt-1 w-full rounded-2xl border border-gray-300 p-2 focus:ring-2 focus:ring-blue-300"
            ...
            <button
              ...
              type="submit"
              className={`w-full rounded-2xl px-6 py-2 text-xl ${
                canBook && isLoggedIn
