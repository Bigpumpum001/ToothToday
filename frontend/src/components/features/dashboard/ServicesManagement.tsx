          ...
          {servicesWithContent.map((service) => (
            ...
            >
              ...
              <div className="flex flex-grow flex-col p-4 md:p-5">
                <h4 className="mb-2 flex-grow text-center text-lg font-bold text-blue-900 md:text-xl">
                  {service.name}
                </h4>
                <p className="mb-4 flex-grow text-sm text-gray-600 md:text-base">
                  {service.short_description}
                </p>

                {/* Service Details */}
                <div className="mb-4 space-y-2 text-xs sm:text-sm xl:text-base">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex flex-1 items-center justify-center rounded bg-amber-500 p-2 text-sm text-white transition-colors hover:bg-yellow-600 md:text-base"
                  >
                    <Pencil />
                  </button>
                  <button
                    onClick={() => handleDeleteService(service.id)}
                    className="flex flex-1 items-center justify-center rounded bg-red-500 p-2 text-sm text-white transition-colors hover:bg-red-600 md:text-base"
                  >
                    <Trash />
                  </button>
                </div>
