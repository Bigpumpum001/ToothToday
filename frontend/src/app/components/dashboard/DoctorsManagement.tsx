...
export default function DoctorsManagement() {
  ...
  return (
    <div className="space-y-6">
          ...
          {filteredDoctors.map((doctor) => (
            ...
            >
              ...
              <div className="p-4 md:p-5 flex flex-col flex-grow">
                <h4 className="text-blue-900 font-bold text-sm sm:text-xl mb-2 flex-grow">
                  {doctor.name}
                </h4>
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex justify-center flex-1 bg-yellow-500 text-white p-1 rounded hover:bg-yellow-600 transition-colors text-sm md:text-base"
                  >
                    <Pencil />
                  </button>
                  <button
                    onClick={() => handleDeleteDoctor(doctor.id)}
                    className="flex-1 flex justify-center bg-red-500 text-white p-1 rounded hover:bg-red-600 transition-colors text-sm md:text-base"
                  >
                    <Trash />
                  </button>
                </div>
      ...
      {/* Schedules Section */}
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-center mb-4 space-y-0">
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-slate-400 text-blue-900">
                ...
                <th className="text-left p-2">วัน</th>
                <th className="text-left p-2">เวลาเริ่ม</th>
                <th className="text-left p-2">เวลาสิ้นสุด</th>
                ...
                >
                  ...
                  <td className="p-2 gap-1 flex">
                    <button
                      ...
                      className="flex justify-center items-center bg-yellow-500 text-white py-1 rounded mr-2 hover:bg-yellow-600 w-full"
                    >
                      <Pencil />
                    </button>
                    <button
                      onClick={() => handleDeleteSchedule(schedule.id)}
                      className="flex justify-center items-center bg-red-500 text-white  rounded hover:bg-red-600 w-full"
                    >
                      <Trash />
                    </button>
                  </td>
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6">
              <form id="doctorForm" onSubmit={handleDoctorSubmit}>
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      ตารางเวลาเข้าเวรแพทย์ (ใช้สำหรับการจัดตารางและอ้างอิงในอนาคต)
                    </label>
                    <textarea
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full p-2 border border-slate-300  rounded bg-white overflow-y-auto"
                      >
            ...
            <div className="p-4 md:p-6 border-t border-t-slate-300 bg-gray-50">
              <div className="flex justify-end space-x-2">
                ...
                <button
                  type="submit"
                  form="scheduleForm"
                  className="px-4 py-2 bg-blue-800 hover:bg-blue-900 text-white rounded "
                >
